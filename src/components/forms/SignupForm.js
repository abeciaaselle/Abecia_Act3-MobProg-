...
export default function LoginForm({ navigation }) {
  ...
  return (
    <View styles={{ flex: 1 }}>
     <Image source={require("../../../assets/images/user.png")} style={{ width: 350, height: 300, marginBottom: 10, marginTop: -120, justifyContent: 'center', alignItems: 'center', marginStart: 10 }} />

...
export default function LoginForm({ navigation }) {
  ...
  const handleLogin = async (values) => {
    try { 
      const url = "http://10.0.0.41/api/v1/login";
  ...
  return (
    ...
    >
      {({
        ...
        return (
          <View styles={{ flex: 1 }}>
            <Image source={require("../../../assets/images/landing.png")} style={{ width: 350, height: 300, marginBottom: 20, marginTop: -180, justifyContent: 'center', alignItems: 'center', marginStart: 10 }} />
